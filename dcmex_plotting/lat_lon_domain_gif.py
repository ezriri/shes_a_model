...
variable_1 = 'graupel_mass_L' # this will be a heatmap
variable_2 = 'upward_air_velocity' # can pass None if dont want any contours

variable_1_colour = None #['coolwarm']

variable_2_contour_levels = [5, 2] 
variable_2_colours = ['red', 'yellow']
...
for t in time_list:
    ...
    if variable_2 is not None:
        easy_plotting_lat_lon_map(a_time, variable_name=variable_2, colourmesh_contour='contour', contour_level= variable_2_contour_levels , specific_colourmap=variable_2_colours)
