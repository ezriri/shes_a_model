...
## plotting stuff
plt_max_alt = 16000
variable_1 = 'cloud_g_kg' # this will be a heatmap
# think use a different colour if using specific vmax
variable_1_colour = None #['coolwarm'] #['Purples']#None#['Greens_r']#None #['coolwarm']
variable_1_vmax = None #8 #70 #1#10 #100 #1000 70 - graupel / L max
log_colourbar = True
...
with tempfile.TemporaryDirectory(dir=specif_save_folder, prefix="tmp_") as tmp_dir:
    ...
    gif_path = os.path.join(specif_save_folder, f'{gif_save_name}.gif')
